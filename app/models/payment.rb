class Payment < ActiveRecord::Base
  attr_accessible :amount, :canceled, :completed, :digital, :identifier, :non_profit_id, :popup, :recurring, :token
  ...
  DESCRIPTION = {
    item: 'New churches signup fee',
    instant: 'New churches signup fee',
